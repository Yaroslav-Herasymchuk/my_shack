...
for button in buts:
    ...
    tkt.Button(text= button, bg = 'blue', font=('Arial', 20), command = get_lbl).place(x =x , y=y, width = 115, height = 80)
    x+= 120
    if x> 400:
        x= 20
        y+= 85
goo = '0'
label_txt= tkt.Label(text= goo, font = ('Arial',35, 'bold'), bg = 'grey',fg = 'white')
